---
title: 'Creating programmatic articles'
...
You don't need to create any documents in order to generate articles. They can be extremely helpful, and a nice addition, but they are entirely optional.
...
Start by giving your project a name. This functions exactly the same as project names in the Batch Generator - it won't affect your articles and is simply so you can identify your project.
...
What we're essentially doing here is telling Byword: Whenever the {location} variable appears in my template, I want that to be mapped to a value of 'Country' in my dataset. Similarly, I want {plant} to be mapped to the corresponding value of 'Plant'.

If you have documents in your account, and that are ready to be used, you'll see the ability to associate them with your project.

\[image]

See the Documents page for more details

Documents are entirely optional, and if you haven't [created any yet](/documents) or can't see this box, then don't worry!
