...
<details>
  <summary>Is this really unlimited?</summary>
...
<details>
  <summary>What does 'dedicated server space' mean?</summary>
...
<details>
  <summary>How long does it take to setup a dedicated Byword server?</summary>
...
<details>
  <summary>How much does it cost to use the OpenAI API?</summary>
