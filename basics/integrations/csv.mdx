...
2. Select individual articles by checking the boxes next to them
...
1. Navigate to your "My Content" page
2. Locate the campaign you want to export
3. Click the "Download" button next to the campaign name
...
- Use Markdown for platforms like Ghost or Jekyll
