...
When you visit the Create Content screen (byword.ai/create), you'll have three main options for creating content:
...
6. Review your article with its AI-generated image

Remember that each article generation requires 1 credit, and regenerating articles also requires an additional credit due to server costs.
...
Once your campaign begins, the process runs in the background, and you'll receive a notification when your project is complete.
...
2. Enter each article's information in the following format:




   *Title;Subheading1;Subheading2;Subheading3;Subheading4*
