...
Byword's [Documents](https://byword.ai/settings?show=documents) feature allows you to upload custom materials that provide additional context and expertise for AI-generated content. By integrating your specialized knowledge, Byword creates more accurate, relevant content that reflects your brand's unique perspective.
...
1. Navigate to your settings page and click "Create document", or head [here](https://byword.ai/documents)

2. Enter a descriptive name for your document

3. Select your source type (File, Audio, URL, or Text)

4. Upload your file or paste your content

5. Once processed, toggle the document to "Active" status
